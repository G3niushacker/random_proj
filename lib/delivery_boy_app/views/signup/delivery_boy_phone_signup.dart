...
class DeliveryBoyPhoneSignup extends StatefulWidget {
  @override
  _DeliveryBoyPhoneSignupState createState() => _DeliveryBoyPhoneSignupState();
}

class _DeliveryBoyPhoneSignupState extends State<DeliveryBoyPhoneSignup> {
